...
SELECT 'Q1 optimized. Выборка секретных действующих документов по подразделениям и сроку действия' AS query_name;
...
SELECT 'Q2 optimized. Агрегация операций сотрудника за период с соединением документов' AS query_name;
...
SELECT 'Q3 optimized. Поиск несекретных документов, по которым были изменения срока действия' AS query_name;
