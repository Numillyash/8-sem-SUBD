...
df = pd.read_csv(REPORT / "05_update_indexes_measurements.csv")
...
make_line(
    ...
    "Среднее время обновления пакета 1000 строк, мс",
    "UPDATE 1000 строк при разных типах индексов",
    "05_update_indexes.png",
)

make_line(
    "avg_elapsed_ms_per_row",
    "Среднее время обновления одной строки, мс",
    "UPDATE: среднее время одной строки при разных типах индексов",
    "05_update_indexes_per_row.png",
)

print("saved:", CHARTS / "05_update_indexes.png")
print("saved:", CHARTS / "05_update_indexes_per_row.png")
