...
BEGIN
    ...
    LOOP
        ...
        PERFORM lab4.measure_insert_table('insert_no_index',          'no_index',         v_rows, 1000, 5);
        PERFORM lab4.measure_insert_table('insert_simple_btree',      'simple_btree',     v_rows, 1000, 5);
        PERFORM lab4.measure_insert_table('insert_unique_btree',      'unique_btree',     v_rows, 1000, 5);
        PERFORM lab4.measure_insert_table('insert_expression_index',  'expression_index', v_rows, 1000, 5);
        PERFORM lab4.measure_insert_table('insert_function_index',    'function_index',   v_rows, 1000, 5);
    END LOOP;
END $$;
