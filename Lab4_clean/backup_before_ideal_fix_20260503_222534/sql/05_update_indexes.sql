...
BEGIN
    ...
    LOOP
        ...
        PERFORM lab4.measure_update_table('update_no_extra_index',    'no_extra_index',  v_rows, 1000, 5);
        PERFORM lab4.measure_update_table('update_simple_btree',      'simple_btree',    v_rows, 1000, 5);
        PERFORM lab4.measure_update_table('update_unique_btree',      'unique_btree',    v_rows, 1000, 5);
        PERFORM lab4.measure_update_table('update_expression_index',  'expression_index',v_rows, 1000, 5);
        PERFORM lab4.measure_update_table('update_function_index',    'function_index',  v_rows, 1000, 5);
    END LOOP;
END $$;
